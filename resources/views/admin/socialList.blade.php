            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('socialAddPage') }}" type="button" class="btn btn-block btn-outline-success mb-3">Add</a>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $social->url }}</td>
                                        <td>
                                            <a href="{{ route('socialEditPage', ['id' => $social->id]) }}" type="button" class="btn btn-block btn-warning">Edit</a>
                                        </td>
                                        <td>
                                            <a href="{{ route('socialDelete', ['id' => $social->id]) }}" type="button" class="btn btn-block btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        {{ $socials->links('vendor.pagination.table') }}
                    </div>
                </div>
            </div>
        </div>
